/// this test is a copy of chess.js test for SAN
/// @link https://github.com/jhlywa/chess.js/blob/master/__tests__/standard-algebraic-notation.test.ts
...
pub mod san_tests {
    ...
    const TEST_POSITIONS: [FenAndMoves; 7] = [
        FenAndMoves {
    ...
    #[test]
    fn standard_algebraic_notation_ok() {
